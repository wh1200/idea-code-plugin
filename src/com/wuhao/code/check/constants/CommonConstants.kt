 ...
 * @param fix 修复方法
 */
fun ProblemsHolder.registerWarning(element: PsiElement, message: String, fix: LocalQuickFix) {
 ...
 * @param message 注册错误提示
 */
fun ProblemsHolder.registerWarning(element: PsiElement, message: String) {
