...
class KotlinArrangementParseInfo {
  ...
  private val myFieldDependencies = HashMap<KtProperty, MutableSet<KtProperty>>()
  ...
  fun registerFieldInitializationDependency(fieldToInitialize: KtProperty, usedInInitialization: KtProperty) {
    var fields: MutableSet<KtProperty>? = myFieldDependencies[fieldToInitialize]
    if (fields == null) {
      fields = ContainerUtil.newHashSet()
      myFieldDependencies[fieldToInitialize] = fields
    }
