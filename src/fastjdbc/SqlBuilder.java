...
public abstract class SqlBuilder {
  ...
  public static class InsertSqlBuilder extends SqlBuilder {
    ...
    public <T> InsertSqlBuilder insert(T saveEntity) {
      ...
      sqlBuilder.append("(")
          ...
          .append(")");
      entity.getOptionalVersionField().ifPresent(vf -> EntityUtil.setVersion(saveEntity, vf));
      entity.getOptionalCreateDateField().ifPresent(cdf -> EntityUtil.setDate(saveEntity, cdf));
      entity.getOptionalUpdateDateField().ifPresent(udf -> EntityUtil.setDate(saveEntity, udf));
  ...
  public static class UpdateSqlBuilder extends SqlBuilder {
    ...
    private <T> UpdateSqlBuilder(Class<T> entityClass) {
      ...
      entity.getOptionalVersionField().ifPresent(
    ...
    public <T> UpdateSqlBuilder update(T updateEntity) {
      ...
      entity.getOptionalUpdateDateField().ifPresent(udf -> {
      ...
      for (EntityField entityField : entity.getNonePrimaryKeyOrderedFields()) {
        if ((entity.getOptionalVersionField().isPresent() && entity.getOptionalVersionField().get() == entityField) ||
            (entity.getOptionalUpdateDateField().isPresent() && entity.getOptionalUpdateDateField().get() == entityField) ||
            (entity.getOptionalCreateDateField().isPresent() && entity.getOptionalCreateDateField().get() == entityField)) {
          continue;
        }
      ...
      entity.getOptionalVersionField().ifPresent(vf -> and().equal(vf.getFieldName(), EntityUtil.readValue(updateEntity, vf)));
      return this;
    }
  }
